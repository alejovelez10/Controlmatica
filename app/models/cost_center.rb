...
class CostCenter < ApplicationRecord
  ...
  def change_state
    ...
    hour_cotizada = self.hour_cotizada_changed? == true ? ("<p>La Hora de valor cotizada: <b class='color-true'>#{self.hour_cotizada_value_change[0]}</b> / <b class='color-false'>#{self.hour_cotizada_value_change[1]}</b></p>") : "" 
