...
#  index_contractors_on_sales_date_year        (EXTRACT(year FROM sales_date))
#  index_contractors_on_sales_date_year_month  (EXTRACT(year FROM sales_date), EXTRACT(month FROM sales_date))
