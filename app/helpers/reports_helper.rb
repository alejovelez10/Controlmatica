		...
		reports.collect do |report|
			{
                ...
                :contact => { id: report.contact.id, name: report.contact.name },
                ...
                :customer => { id: report.contact.id, name: report.customer.name },
                ...
                :report_execute => { id: report.report_execute.id, names: report.report_execute.names },
                :report_execute_id => report.report_execute_id,
                :report_sate => report.report_sate,
                :total_value => report.total_value,
                :update_user => report.update_user,
                :updated_at => report.updated_at,
                :user => { id: report.user.id, names: report.user.names },
