...
class ReporterHours extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div>
                ...
                <div className="dashboard-card">
                    <BarReporterHours leyend={true} data={this.state.data} title={"Tus Horas por Mes"} height={this.props.height} />
                </div>
            </div>
        )
