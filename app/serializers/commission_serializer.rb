...
class CommissionSerializer < ActiveModel::Serializer
  attributes :id, :created_at, :updated_at, :is_acepted, :last_user_edited, :user, :user_invoice, :total_value, :user_invoice_id, :start_date, :end_date, :customer_invoice_id, :observation, :hours_worked, :total_value, :customer_invoice
