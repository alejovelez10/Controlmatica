class EmployedPerformanceController < ApplicationController
  ...
  def info_pdf_new
    ...
    dataTable1 = [ 
      ["Empleado: #{user.names}", {:content => "Fecha hasta: #{fecha_hasta}", :rowspan => 2, :padding => [15, 0, 0, 10]}], 
    ...
    respond_to do |format|
      format.pdf do
        ...
        pdf.table([headers] + array, :header => true, :width => 540, cell_style: {align: :center, :top_margin => 100} ) do |table|
