# Bitácora de las 8 olas — histórico completo

> **Este archivo es el histórico crudo, tal como se escribió al cerrar cada ola.** Se separó de
> `ESTADO.md` en la ola 8 (paquete 13) porque ese documento había crecido a 2.605 líneas con
> correcciones apiladas al final que contradecían el cuerpo, y era imposible saber qué párrafo
> mandaba sobre cuál.
>
> 🔴 **NADA DE ESTE ARCHIVO MANDA.** El estado real y consolidado del proyecto está en
> `ESTADO.md`. Aquí se conserva el detalle de cada ola —las mediciones, los hallazgos de cada
> verificación independiente y las correcciones sucesivas— para quien necesite reconstruir por
> qué se tomó una decisión. Varias afirmaciones de este archivo quedaron obsoletas por olas
> posteriores y **no se han editado a propósito**: reescribir el histórico es justamente lo que
> hizo ilegible el documento original.
